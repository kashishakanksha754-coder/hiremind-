...
const ROLES: {
...
}[] = [
  {
    ...
    description: "Screen candidates, run AI interviews, and hire faster.",
    icon: Users,
  },
  {
    value: "candidate",
    title: "I'm a Candidate",
    description: "Practice interviews and showcase your skills to top teams.",
    icon: UserCircle2,
  },
];
...
export default function SignupPage() {
  ...
  function handleContinue() {
    if (!role) {
      toast({
        title: "Select a role",
        description: "Tell us how you'll be using HireMind.",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="grid-bg relative flex min-h-screen items-center justify-center bg-bg-primary bg-gradient-to-b from-bg-primary via-bg-primary to-accent-violet/5 px-4 py-12">
            ...
            <>
              <div className="mb-6 text-center">
                ...
                <p className="mt-1 text-sm text-text-secondary">
                  First, tell us how you'll use HireMind.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <label className="flex cursor-pointer items-start gap-2 text-sm text-text-secondary">
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 rounded border-border-subtle bg-bg-secondary text-accent-blue accent-accent-blue"
                    required
                  />
                  <span>
                    I agree to the{" "}
