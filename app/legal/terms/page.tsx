      ...
      <div className="container">
        <div className="mx-auto max-w-3xl py-16">
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                ...
                the HireMind platform and related services (the "Service"). By
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                HireMind is an AI-assisted recruitment platform that helps
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                As a recruiter using HireMind, you act as the Data Fiduciary or
                Data Controller in respect of the candidate data you process
                through the Service, and HireMind acts as your processor. You are
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                ...
                HireMind are generated by automated models and are provided as
                ...
                candidate. HireMind does not guarantee any particular outcome and
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                HireMind may offer a free trial that converts to a paid plan
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                HireMind and its licensors retain all rights, title and interest
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                To the maximum extent permitted by law, HireMind shall not be
                ...
                Service shall not exceed the amounts paid by you to HireMind in
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-text-secondary">
              <p>
                You agree to indemnify and hold harmless HireMind and its
